...
class OCREndpointTester:
    ...
    def build_request(self, image_path: Path, prompt: str = "Convert the document to markdown.") -> dict:
    ...
    async def test_connection(self):
        ...
        try:
            ...
            async with websockets.connect(self.ws_url, extra_headers=headers, open_timeout=10) as ws:
            ...
            async with websockets.connect(self.ws_url, extra_headers=headers) as ws:
                ...
                while True:
                    ...
                    if data.get("status") == "completed":
                        ...
                        # Decrypt content
                        encrypted_content = data["result"]["choices"][0]["message"]["content"]
    ...
    async def run_all_tests(self, image_path: Path = None):
        """Run all tests."""
        print("=" * 60)
...
async def main():
    ...
    parser.add_argument("--url", required=True, help="WebSocket URL (e.g., wss://host/ws/ocr)")
